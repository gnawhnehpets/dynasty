...
export const leagueName = "SC Dynasty"; // your league name
...
export const homepageText = `
  <p><strong><u>Welcome to the inaugural season!</u></strong></br><img src="https://c.tenor.com/EJ6Bm6cGg4IAAAAC/farmerfran-waterboy.gif" style="width:80%" class="center"></img></p>
  <p>No consensus on date so far, but the most amenable seems to be 8/28 on Sunday 7-10 PM. If this date is completely not doable please reach out to me ASAP.  I know this is short notice, but hopefully we can all carve out time on this date.</p><p>League Rules Version 1.0 <a href="https://dynasty-three.vercel.app/constitution">here</a> (Subject to change, but major cornerstones of what should be good are in place).</p>
  ...
  <p>Development was geared towards the mobile app. You can use <a href="https://sleeper.com/login">https://sleeper.com/login</a> and try the web version.</p>
  <p>Venmo: @Scott-Hur</br>Quickpay: shur86@gmail.com</p>
  
  <p>Start researching your rookies!!!!!</p>
  
  <p>Want to reiterate that there may be some growing pains for the first year, but I will try my best to make this an enjoyable league for all participants and iterate towards maintaining a worthwhile and compelling long term league</p>
...
export const managers = [
    {
     ...
     },
     {
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Fuck around with the fantasy gods and find out",
      "tradingScale": 10, // 1 - 10
      "preferredContact": "Text", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    }
    ,
    ...
    ,
    {
      ...
      "favoritePlayer": 422, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      // "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      // "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Your fantasy team's philosophy",
      "tradingScale": 10, // 1 - 10
    ...
    },
    {
      ...
      "favoritePlayer": 555, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      // "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      // "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Your fantasy team's philosophy",
      "tradingScale": 10, // 1 - 10
    ...
    },
    {
      ...
      "favoritePlayer": 432, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Your fantasy team's philosophy",
      "tradingScale": 10, // 1 - 10
    ...
    },
    {
      ...
      "name": "Ashish",
      // "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Trump Country", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
    ...
    },
    {
      ...
      "favoritePlayer": 222, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Your fantasy team's philosophy",
      "tradingScale": 10, // 1 - 10
